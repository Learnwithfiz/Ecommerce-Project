          ...
          <div class="row">
            <div class="col-12">
               ...
               <table id="myTable" class="display">
                ...
                <tbody>
                    <?php 
                    $sel = "SELECT confirm_order.user_id ,order_product.date,
                    order_product.name,order_product.email, 
                    order_product.user_order,order_product.total_taka from confirm_order,order_product
