      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
                <h1>Add Product</h1>
                <button id="addData" class="btn btn-primary p-2">add data</button>
    ...
    <div class="chat-windows"></div>
      <script>
         ...
         $("#addData").click(function() {
            ...
            "<td><button class='btn btn-success cancle-btn'>cancel </buton></td>"+ 
            "</tr>";
