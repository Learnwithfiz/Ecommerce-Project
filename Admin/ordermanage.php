    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           email:<span id="email"></span> <br>
            total_order: <span id="total_order"></span><br>
           payment: <span id="payment"></span><br>
      ...
      function view(id){
        ...
        $.ajax({
          ...
          success:function(response){
             ...
             $("#total_order").html(mydata.user_order);
             $("#payment").html(mydata.payment);
