          ...
          <nav class="sidebar-nav">
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="ordermanage.php" class="sidebar-link"
                      ><i class="mdi mdi-account-key"></i><span class="hide-menu"> Order  </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="Confirm.php" class="sidebar-link"
                      ><i class="mdi mdi-account-key"></i><span class="hide-menu"> Confirm order  </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="earn.php" class="sidebar-link"
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
               ...
               $total=0;
                    $sel = "SELECT order_product.total_taka,order_product.month
                     from confirm_order,order_product
                     WHERE order_product.id =confirm_order.user_id AND order_product.month='$month'";
                     $ex = mysqli_query($con,$sel);
                    while($row=mysqli_fetch_array($ex)){
                        
                      $total += (int)$row['total_taka'];
                    }
                    ?>
             <h1>  Total Earning January<?php  echo    $total; ?>  </h1>
              <a href="January.php"><button class="btn btn-primary">January</button></a>
              <a href="February.php"><button class="btn btn-success">February</button></a>
              <a href="March.php"><button class="btn btn-danger">March</button></a>
              <a href="April.php"><button class="btn btn-primary">April</button></a>
            </div>
          </div>
